...
export const CollectInfoIcon: React.FC<IconProps> = ({ color = "#F2994A" }) => (
  <svg width="40" height="40" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <svg x="18" y="18" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M16.7574 2.99679L14.7574 4.99679H5V18.9968H19V9.23943L21 7.23943V19.9968C21 20.5491 20.5523 20.9968 20 20.9968H4C3.44772 20.9968 3 20.5491 3 19.9968V3.99679C3 3.4445 3.44772 2.99679 4 2.99679H16.7574ZM20.4853 2.09729L21.8995 3.51151L12.7071 12.7039L11.2954 12.7063L11.2929 11.2897L20.4853 2.09729Z" fill={color}/>
    </svg>
  </svg>
);
...
export const SubmitIcon: React.FC<IconProps> = ({ color = "#E0E0E0" }) => (
  <svg width="40" height="40" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="30" cy="30" r="29" stroke={color} strokeWidth="2"/>
    <svg x="18" y="18" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M21 3C21.5523 3 22 3.44772 22 4V20.0066C22 20.5552 21.5447 21 21.0082 21H2.9918C2.44405 21 2 20.5551 2 20.0066V19H20V7.3L12 14.5L2 5.5V4C2 3.44772 2.44772 3 3 3H21ZM8 15V17H0V15H8ZM5 10V12H0V10H5ZM19.5659 5H4.43414L12 11.8093L19.5659 5Z" fill={color}/>
    </svg>
  </svg>
);
